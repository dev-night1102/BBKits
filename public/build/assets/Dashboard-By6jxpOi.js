import{J as h,r as p,j as e,Q as g}from"./app-CuJr9BXe.js";import{A as b}from"./AuthenticatedLayout-BqcKOmD6.js";import{S as u}from"./SalesModal-B4jxMeYR.js";import{R as f}from"./RankingDisplay-BQpOGIDT.js";import"./transition-Cf6ijMFq.js";import"./x-iojtnljs.js";import"./createLucideIcon-2f64EPTt.js";const t=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function R(){var o;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
