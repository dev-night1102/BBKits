import{J as v,r as i,S as m,j as e,Q as j}from"./app-QNzT34cD.js";import{A as w}from"./AuthenticatedLayout-DX4CeDBq.js";import"./transition-B3WP8PPb.js";function B({stats:t,topPerformers:o,recentSales:d,monthlyData:N}){const{auth:h}=v().props,[x,l]=i.useState(!1),[n,p]=i.useState(!0),[c,y]=i.useState(30),g=()=>{l(!0),m.reload({only:["stats","topPerformers","recentSales","monthlyData"],preserveScroll:!0,preserveState:!0,onSuccess:()=>{l(!1)},onError:()=>{l(!1)}})};i.useEffect(()=>{if(!n)return;const a=setInterval(()=>{l(!0),m.reload({only:["stats","topPerformers","recentSales","monthlyData"],preserveScroll:!0,preserveState:!0,onSuccess:()=>{l(!1)},onError:()=>{l(!1)}})},c*1e3);return()=>clearInterval(a)},[n,c]);const r=a=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(a),f=a=>new Date(a).toLocaleDateString("pt-BR"),u=a=>{const s={pendente:"bg-gradient-to-r from-yellow-400 to-orange-500 text-white shadow-lg",aprovado:"bg-gradient-to-r from-green-400 to-emerald-500 text-white shadow-lg",recusado:"bg-gradient-to-r from-red-400 to-pink-500 text-white shadow-lg"},b={pendente:"Pendente",aprovado:"Aprovado",recusado:"Recusado"};return e.jsx("span",{className:`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold transform hover:scale-105 transition-all duration-300 ${s[a]}`,children:b[a]})};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
