import{J as h,r as p,j as e,Q as g}from"./app-BO0N5iw1.js";import{A as b}from"./AuthenticatedLayout-B5G_Cb_n.js";import{S as u}from"./SalesModal-zEymkn10.js";import{R as f}from"./RankingDisplay-CPfQDSyK.js";import"./transition-CiCH3G_t.js";import"./x-B1_HI8x_.js";import"./createLucideIcon-C9Gf8qeN.js";const t=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function R(){var o;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
