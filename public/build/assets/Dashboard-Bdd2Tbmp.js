import{J as h,r as p,j as e,Q as g}from"./app-CmBlcd84.js";import{A as b}from"./AuthenticatedLayout-CmWRajLL.js";import{S as u}from"./SalesModal-BxUfIgL3.js";import{R as f}from"./RankingDisplay-DQEDjyfv.js";import"./transition-NaYtFRWC.js";import"./x-cXTbRfC6.js";import"./createLucideIcon-CI6KjjIU.js";const t=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function R(){var o;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
