import{J as h,r as p,j as e,Q as g}from"./app-DxZa_Y0_.js";import{A as b}from"./AuthenticatedLayout-DtUB3Mjo.js";import{S as u}from"./SalesModal-Bl69k77U.js";import{R as f}from"./RankingDisplay-BTE6BrK4.js";import"./transition-BzKJ7yIc.js";import"./x-BX3WJEKi.js";import"./createLucideIcon-HgYI3pPh.js";const t=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function R(){var o;const{auth:l,gamification:r,salesData:s,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
